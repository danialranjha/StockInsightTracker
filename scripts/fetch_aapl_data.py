...
def fetch_and_save_data(symbols):
    """Fetch data for given symbols and save it for test mocking, with caching, rate limiting, and retry logic."""
    for symbol in symbols:
        # Rate limiting: wait at least 5 seconds between requests per symbol to avoid 429 errors
        time.sleep(5)
