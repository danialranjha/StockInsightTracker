...
import pandas as pd
from utils.stock_data import get_stock_data, retry_with_backoff, prepare_download_data
import requests
...
class TestStockData:
    ...
    def test_get_stock_data_success(self, mock_retry, mock_ticker):
        ...
        mock_balance_sheet = pd.DataFrame(
            ...
            index=['Long Term Debt', 'Total Assets', 'Goodwill And Other Intangible Assets'],
            columns=[0]
        )
